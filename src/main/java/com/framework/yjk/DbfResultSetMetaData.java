...
public class DbfResultSetMetaData implements ResultSetMetaData {
     ...
     */
    DbfResultSetMetaData(String tableName, String[] columnNames,
                         String[] columnLabels, String[] columnTypes,
                         int[] columnDisplaySizes,
                         Map<String,String> colAliasNameMap) {
    ...
    public String getColumnName(int column) throws SQLException {
        // SQL column numbers start at 1
        String colName = columnNames[column - 1];
        if (null != colAliasNameMap){
            String aliasName = colAliasNameMap.get(colName);
            if (null != aliasName){
                return aliasName;
            }
        }
